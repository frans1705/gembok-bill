...
class ConfigValidator {
    ...
    async testMikrotikConnection() {
        try {
            const mikrotikHost = getSetting('mikrotik_host', '192.168.99.1');
            const mikrotikPort = getSetting('mikrotik_port', '8728');
            const mikrotikUser = getSetting('mikrotik_user', 'genieacs');
            const mikrotikPassword = getSetting('mikrotik_password', 'n4ncy.n3t');
